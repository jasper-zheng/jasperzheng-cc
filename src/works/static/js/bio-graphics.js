...
function init2(){
  ...
  scene2.background = new THREE2.Color("rgb(245, 245, 245)");
  camera2 = new THREE2.PerspectiveCamera(4, canvas_w2/canvas_h2, 1, 100);
...
const nurbsMaterial = new THREE2.LineBasicMaterial( { color: 0x000000, linewidth: 3} );
